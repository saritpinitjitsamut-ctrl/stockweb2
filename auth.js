// Supabase Configuration (Namespaced to avoid collisions)
const AUTH_CONFIG = {
    URL: 'https://aozzwdaujwuefbkrnbbd.supabase.co',
    KEY: 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImFvenp3ZGF1and1ZWZia3JuYmJkIiwicm9sZSI6ImFub24iLCJpYXQiOjE3ODA2MDM3NjksImV4cCI6MjA5NjE3OTc2OX0.KkjFlJcyV-Mi_DJE8iIEr28cv84Eq-OXkVhLr20f5es'
};

// Initialize Supabase
let supabaseClient = null;
if (window.supabase) {
    // Only create if not already exists or just create our own internal one
    supabaseClient = window.supabase.createClient(AUTH_CONFIG.URL, AUTH_CONFIG.KEY);
}
...
const PAGE_ROLES = {
    ...
    'production.html': ['pdtPerson', 'Ceo', 'APRD'],
...
function redirectBasedOnRole(user, role = null) {
    if (role) {
        ...
        else if (role === 'APRD') window.location.href = 'production.html';
